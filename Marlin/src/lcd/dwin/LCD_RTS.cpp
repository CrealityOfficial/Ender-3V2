...
#define DEFAULT_LANGUAGE 2	// 1: CN, 2: EN, 
...
void lcd_eight_language(void)
{
  ...
  rtscheck.RTS_SndData(language_change_font, No_leveling_VP);
}
...
void RTSSHOW::RTS_Init()
{
  ...
  AxisUnitMode = 1;
  #if HAS_LEVELING
    zprobe_zoffset = last_zoffset = probe_offset.z;
